...
module.exports = {
    ...
    fetchEdit: async(req, res) => {
        ...
        try {
            ...
            const fetch = await remainder.findOne({where: {id: id, jenis_remainder: 'domain'}});
            if(fetch != null){
    ...
    editById: async(req, res) => {
        ...
        try {
            ...
            const domain_remainder = await remainder.findOne({where: {id: id_remainder, jenis_remainder: 'domain'}});
            if(domain_remainder !== null){
    ...
    editBayar: async(req, res) => {
        ...
        try {
            ...
            if(domain_remainder !== null){
                ...
                let tglTerbayar = domain_remainder.tgl_tagihan_telah_lunas;
                let tglJth = domain_remainder.tgl_jatuh_tempo;
                ...
                await remainder.update(obj, {where: {id: id_remainder, jenis_remainder: 'domain'}})
                .then( result => {
    ...
    deleteRemainder: async(req, res) => {
        ...
        try {
            ...
            let remaind = await remainder.findOne({where: {id:id, jenis_remainder: 'domain'}});
            if(remaind != null){
                await remainder.destroy({where: {id: id, jenis_remainder: 'domain'}})
                .then( result => {
